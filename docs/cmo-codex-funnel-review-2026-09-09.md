...
Lead with the free Clean download. Offer Worlds for $10 once when its delivery path is verified. Show Crew as coming at $10/month, with no checkout link. The source of pricing is Pizza Fleet's `docs/marketing/lines.md`, `THE PRICING RECORD`, introduced in `8be9c23`.
...
| Crew availability should be visible before reading the body | The heading is `$10 a month — the crew`; availability is in the following paragraph. | Proposed heading: `Crew — coming · $10/month`. Proposed body: `Shared realms for your team, across machines. Crew play is not available yet.` Keep no purchase control. |
